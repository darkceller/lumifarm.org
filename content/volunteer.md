...
<div style="max-width: 800px; margin: 0 auto; text-align: center; line-height: 1.8; padding-top: 2rem;">
  ...
  <h3 style="margin-top: 3rem; color: #4ade80; font-size: 1.5rem;">你可以期待獲得什麼？</h3>
  <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 2rem; margin-top: 1.5rem; text-align: left; display: inline-block;">
    <ul style="list-style: none; padding: 0; margin: 0; font-size: 1.1rem;">
      <li style="margin-bottom: 1rem; display: flex; align-items: flex-start; gap: 10px;">✅ <span>與一群熱愛土地的夥伴共同協作，建立深厚的社群連結。</span></li>
      <li style="margin-bottom: 1rem; display: flex; align-items: flex-start; gap: 10px;">✅ <span>獲得友善農耕與生態保育的實作經驗。</span></li>
      <li style="margin-bottom: 1rem; display: flex; align-items: flex-start; gap: 10px;">✅ <span>協助恢復在地生態系統與生物多樣性。</span></li>
      <li style="display: flex; align-items: flex-start; gap: 10px;">✅ <span>學習糧食自主與永續生活的實用技能。</span></li>
    </ul>
  </div>
  <p style="font-weight: bold; margin-top: 2rem; margin-bottom: 4rem; font-size: 1.1rem; color: #cbd5e1;">無需任何農業經驗 —— 只需要一顆願意學習、不怕弄髒雙手的心！</p>
</div>
...
<div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: center; justify-content: center; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; padding: 1.5rem; margin: 0 auto 4rem auto; box-sizing: border-box; width: 100%;">
  ...
  <div style="flex: 1.5 1 280px; max-width: 100%; box-sizing: border-box; text-align: left;">
    ...
    <ul style="list-style: none; padding: 0; margin-top: 1.5rem; margin-bottom: 2rem;">
...
<hr style="border-color: rgba(255,255,255,0.1); margin-bottom: 4rem;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 1rem; margin-bottom: 4rem;">
  <img src="/images/volunteer-recruitment.png" style="width: 100%; aspect-ratio: 1/1; object-fit: cover; border-radius: 8px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
  <img src="/images/volunteer-recruitment.png" style="width: 100%; aspect-ratio: 1/1; object-fit: cover; border-radius: 8px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
  <img src="/images/volunteer-recruitment.png" style="width: 100%; aspect-ratio: 1/1; object-fit: cover; border-radius: 8px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
  <img src="/images/volunteer-recruitment.png" style="width: 100%; aspect-ratio: 1/1; object-fit: cover; border-radius: 8px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
</div>